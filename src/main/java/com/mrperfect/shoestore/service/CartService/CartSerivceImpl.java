package com.mrperfect.shoestore.service.CartService;
...
import com.mrperfect.shoestore.model.AddtoCart;
import com.mrperfect.shoestore.model.CheckoutCart;
import com.mrperfect.shoestore.model.Products;
import com.mrperfect.shoestore.model.repository.AddToCartRepo;
import com.mrperfect.shoestore.model.repository.CheckoutRepo;
import com.mrperfect.shoestore.service.ProductService.ProductServices;
...
public class CartSerivceImpl implements CartService {
	...
	@Override
	public List<CheckoutCart> getAllCheckoutByCategoryId(String categoryId) {
	
	return checkOutRepo.findByCategory(categoryId);
	}
